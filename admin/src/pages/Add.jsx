    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div>
        ...
        <div className='flex gap-3'>
          ...
          <div onClick={()=>setSizes(prev => prev.includes("50ml") ? prev.filter(item => item !== "50ml") : [...prev,"50ml"])}>
            <p className={`${sizes.includes("50ml") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>50ml</p>
          </div>
          ...
          <div onClick={()=>setSizes(prev => prev.includes("L") ? prev.filter(item => item !== "250ml") : [...prev,"250ml"])}>
          ...
          <div onClick={()=>setSizes(prev => prev.includes("700ml") ? prev.filter(item => item !== "700ml") : [...prev,"700ml"])}>
            <p className={`${sizes.includes("700ml") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>700ml</p>
          </div>
